...
$$
On remarque alors que le mode fondamental $\kappa=0$ correspond à la moyenne en espace de la fonction $u$ ; il devient simple numériquement de forcer la moyenne nulle d'une fonction.
...
$$
  \hat{u}_\kappa \approx \frac{1}{N}\sum_{j=0}^N u(x_j) e^{=i\frac{2\pi j}{N}\kappa}.
$$
