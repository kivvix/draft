...
Cette thèse présente le début de l'analyse de stabilité des méthodes de Lawson dans le contexte d'une équation de transport, et plus particulièrement une équation cinétique. Des travaux récents d'erreur de troncature~\cite{Hochbruck:2020} présentent des résultats sur des problèmes raides où la partie linéaire $L$ vérifie $|e^{\Delta t L}|=1$. Le cadre plus large ($|e^{\Delta t L}|\neq1$) engendre des domaines de stabilités dépendant de la discrétisation de la partie linéaire, comme les schémas exponentiels présentés dans le chapitre~\ref{chap1}. La recherche d'estimations d'erreur dans ce contexte n'est pas encore faite.
