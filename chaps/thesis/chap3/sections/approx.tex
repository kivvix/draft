...
$$
Nous cherchons l'erreur de troncature faite par le schéma lorsque la fonction exponentielle est substituée par $\mathfrak{expr}$ ; notons $\tR$ le schéma couplé à la fonction d'approximation de l'exponentielle $\mathfrak{expr}$. On sait que :
$$
