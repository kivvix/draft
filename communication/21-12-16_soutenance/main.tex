...
\definecolor{sec1}{HTML}{F79F1F}
\definecolor{sec2}{HTML}{A3CB38}
\definecolor{sec3}{HTML}{1289A7}
\definecolor{sec4}{HTML}{D980FA}
\definecolor{sec5}{HTML}{B53471}

%\title[Workshop Bordeaux]{Hybrid model of Vlasov-Maxwell equations\\ and\\ comparison of Hamiltonian method and Lawson method}
\title[LMJL]{Comparison of high-order Eulerian methods for electron hybrid model}
