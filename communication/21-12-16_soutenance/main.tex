...
\begin{frame}{Numerical results: Padé-Lawson adaptive time step}
  ...
  \only<2>{
    \begin{figure}
      ...
      \caption{Time step evolution, classic Lawson (Maxwell outside) and approximate Lawson with Padé or Strang approximation, $\Delta t^n$}
    \end{figure}
    \begin{table}[h]
      \centering
...
\begin{frame}{Conclusion}
  \begin{enumerate}
    \item[\cmark] Numerical estimation of CFL with Python package
